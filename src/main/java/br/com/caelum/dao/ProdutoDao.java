...
public class ProdutoDao {
	...
	public List<Produto> getProdutos(String nome, Integer categoriaId, Integer lojaId) {
		...
		// } else {
		// jpql += " WHERE"; //senão ocorrerá erro de sintaxe SQL ao buscar por nome,
		// por exemplo
		// }
		// if (lojaId != null) {
		...
		//query.where(nomeIgual, localIgual, categoriaIgual); - Desta forma apresenta erro pois as variáveis são locais
